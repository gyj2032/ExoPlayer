...
public final class ProgressiveMediaSource extends BaseMediaSource
  ...
  private boolean onlyKeyFrameRequired = false;
  ...
  public MediaPeriod createPeriod(MediaPeriodId id, Allocator allocator, long startPositionUs) {
    ...
    ProgressiveMediaPeriod period = new ProgressiveMediaPeriod(
        ...
        continueLoadingCheckIntervalBytes);
    period.setOnlyKeyFrameRequired(onlyKeyFrameRequired);
    return period;
  }
  ...
  public void setOnlyKeyFrameRequired(boolean onlyKeyFrameRequired) {
    this.onlyKeyFrameRequired = onlyKeyFrameRequired;
  }
}
